    ...
    <div>
      ...
      <div>
        <div className="create-todo flex justify-center items-center mt-5">
          <input type="text" className="border-2 border-btn-primary-bg outline-none h-10 px-2 rounded-l" />
          <button onClick={createTask} className="bg-btn-primary-bg px-2 py-1 text-white font-bold rounded-r  h-10">
            Add Todo
          </button>
        </div>
      </div>
      <div className="max-w-[1240px] px-5 mx-auto">
        ...
        </DndContext> : <p>NO DATA AVAILABLE</p>
        }
      </div>
    </div>
  );
